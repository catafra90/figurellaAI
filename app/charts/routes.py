...
TO1_BLOCK = {
    ...
    "GK":["1/2 KICK BACK","KICK BACK","SIDE DIAG KICKS"]
}
TO2_BLOCK = {
    "rows": [
        {"Workout":"CHEST UP 90","Rings":"-","Notes":""},
    ...
    "GK":["1/2 KICKS ON BENCH","BALLERINA","INNER FORWARD"]
}
TO3_BLOCK = {
    "rows": [
        {"Workout":"CHEST UP ALT","Rings":"-","Notes":""},
    ...
    "GK":["1/2 TRIANGLES ON B","SQUAT BENCH TOUCH","DIAGONAL INNER B."]
}
TO4_BLOCK = {
    "rows": [
        {"Workout":"DOUBLE KICKS","Rings":"-","Notes":""},
    ...
    "GK":["1/2 CIRCLES BENCH","SUPER MARIO LUNGES","INNER CIRCLES FWD"]
}
TO5_BLOCK = {
    "rows": [
        {"Workout":"DOUBLE TWIST","Rings":"-","Notes":""},
    ...
    "GK":["1/2 OPEN CLOSE (B)","ALTERNATE SQUATS","SIDE DIAGONAL KICKS B"]
}
...
def client_chart(client):
    ...
    try:
        ...
        # Provide all blocks (C, V, TO) into the partial too
